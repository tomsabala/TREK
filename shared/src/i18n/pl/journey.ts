...
const journey: TranslationStrings = {
  ...
  'journey.editor.useCurrentLocation': 'Użyj mojej bieżącej lokalizacji',
  'journey.editor.locationPermissionDenied':
    'Dostęp do lokalizacji został odrzucony. Zezwól na niego w ustawieniach przeglądarki i spróbuj ponownie.',
  'journey.editor.locationTimeout': 'Przekroczono limit czasu pobierania lokalizacji. Spróbuj ponownie.',
  'journey.editor.locationUnavailable': 'Nie udało się ustalić Twojej lokalizacji.',
  'journey.editor.locationInsecureContext': 'Lokalizacja wymaga bezpiecznego połączenia (HTTPS).',
  ...
  'journey.studio.coordsDms': 'Stopnie',
  'journey.studio.coordsDecimal': 'Dziesiętne',
  ...
  'journey.studio.weight': 'Waga',
  'journey.studio.italic': 'Kursywa',
  'journey.studio.tracking': 'Światło',
  'journey.studio.rotation': 'Obrót',
  'journey.studio.opacity': 'Krycie',
  'journey.studio.fill': 'Wypełnienie',
  'journey.studio.fillOn': 'Wypełniony',
  'journey.studio.stroke': 'Obrys',
  'journey.studio.strokeWidth': 'Grubość',
  'journey.studio.gradient': 'Gradient',
  'journey.studio.gradientDown': 'W dół',
  'journey.studio.gradientUp': 'W górę',
  'journey.studio.showIcons': 'Ikony',
  'journey.studio.mapFit': 'Zakres',
  'journey.studio.mapPadding': 'Margines',
  'journey.studio.mapShape': 'Kształt',
  'journey.studio.align.left': 'Do lewej',
  'journey.studio.align.center': 'Do środka',
  'journey.studio.align.right': 'Do prawej',
  'journey.studio.markStyle.plain': 'Zwykły',
  'journey.studio.markStyle.chip': 'Pełny',
  'journey.studio.markStyle.outline': 'Obrysowany',
  'journey.studio.markStyle.stacked': 'Piętrowy',
  'journey.studio.icon': 'Ikona',
  'journey.studio.iconAndLabel': 'Ikona i tekst',
  'journey.studio.iconOnly': 'Tylko ikona',
  'journey.studio.labelOnly': 'Tylko tekst',
  'journey.studio.icons': 'Ikony',
  'journey.studio.iconsForTravel': 'Podróżnicze',
  'journey.studio.iconsAll': 'Wszystkie ikony',
  'journey.studio.searchIcons': 'Szukaj ikon',
  'journey.studio.lineWidth': 'Grubość',
  ...
  'journey.studio.routeDrawn': 'Rysowana',
  'journey.studio.routeArc': 'Długie odcinki',
  'journey.studio.routeStraight': 'Prosta',
  'journey.studio.routeBow': 'Łukowa',
  'journey.studio.routeDashArcs': 'Przerywane łuki',
  'journey.studio.mapStops': 'Przystanki',
  'journey.studio.pinDot': 'Kropki',
  'journey.studio.pinPhoto': 'Zdjęcia',
  'journey.studio.pinPhotoNone': 'Te przystanki nie mają jeszcze zdjęć, więc są rysowane jako kropki.',
  'journey.studio.roads': 'Drogi',
  'journey.studio.roadsFetch': 'Poprowadź po drogach',
  'journey.studio.roadsFollow': 'Po drogach',
  'journey.studio.roadsDirect': 'Bezpośrednio',
  'journey.studio.recommended': 'zalecane',
  'journey.studio.bleed': 'Spad',
  'journey.studio.safeArea': 'Strefa',
  ...
  'journey.detail.searchEmpty': 'Żaden wpis nie pasuje do „{query}”',
  'journey.settings.entryFields': 'Pola wpisu',
  'journey.settings.entryFieldsHint': 'Wyłącz to, czego ta podróż nie używa. Nic z już napisanego nie ginie.',
  'journey.settings.showVerdict': 'Za i przeciw',
  'journey.settings.showMood': 'Nastrój',
  'journey.settings.showWeather': 'Pogoda',
  'journey.entry.suggestion': 'Propozycja',
  'journey.editor.addDetails': '+ Szczegóły',
};
