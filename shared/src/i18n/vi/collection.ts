...
const collection: TranslationStrings = {
  ...
  'collections.file.targetNew': 'Danh sách mới',
  'collections.file.targetNewHint': 'Tệp thành một danh sách riêng',
  ...
  'collections.file.doneIntoNothing': 'Mọi địa điểm trong tệp đều đã có trong {name}',
