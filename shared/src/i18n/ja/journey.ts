...
const journey: TranslationStrings = {
  ...
  'journey.suggestions.restoreCount': '見送った提案（{count}件）',
  'journey.suggestions.restored': '{count} 件の提案が戻りました',
  'journey.detail.addOnThisDay': 'この日に記録を追加',
  'journey.detail.jumpToDay': '{date} へ移動',
  'journey.detail.searchPlaceholder': 'この旅を検索',
  'journey.detail.searchEmpty': '「{query}」に一致する記録はありません',
  'journey.settings.entryFields': '記録の項目',
  'journey.settings.entryFieldsHint': 'この旅で使わないものはオフにできます。すでに書いたものは失われません。',
  'journey.settings.showVerdict': '良かった点・気になった点',
  'journey.settings.showMood': '気分',
  'journey.settings.showWeather': '天気',
  'journey.entry.suggestion': '提案',
  'journey.editor.addDetails': '＋詳細',
};
