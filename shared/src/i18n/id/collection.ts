...
const collection: TranslationStrings = {
  ...
  'collections.file.targetNew': 'Daftar baru',
  'collections.file.targetNewHint': 'Berkas sebagai daftar tersendiri',
  ...
  'collections.file.doneIntoNothing': 'Semua tempat dalam berkas sudah ada di {name}',
