...
export const RETIRED_NOTICE_IDS = [
  ...
  'welcome-v1',
  'release-4-0-0',
  // The upstream release-notes modal and the thank-you modal it replaced: a note
  // from the original maintainer plus their donation links. This fork does not
  // speak for them and does not collect on their behalf, so neither is published
  // here. The modal renderer stays — a release notice declaring `release` still
  // works for whoever runs this fork.
  'release-notes',
  'thank-you-support',
] as const;
