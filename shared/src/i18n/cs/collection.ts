...
const collection: TranslationStrings = {
  ...
  'collections.file.targetNew': 'Nový seznam',
  'collections.file.targetNewHint': 'Soubor jako samostatný seznam',
  ...
  'collections.file.doneIntoNothing': 'Všechna místa ze souboru už v {name} jsou',
