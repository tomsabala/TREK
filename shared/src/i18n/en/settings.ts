...
const settings: TranslationStrings = {
  ...
  'settings.notifyCollectionInvite': 'Collection invitations',
  'settings.notifySynologySessionCleared': 'Synology session cleared',
  'settings.notifyPluginNotification': 'Plugin notifications',
  ...
  'settings.notifyReplicaFailure': 'Storage replica failure',
  ...
  'settings.offline.storage.tripFinished': 'Finished. Only stored if you switch it on.',
  'settings.offline.notice.stored': 'Stored {count} trip(s) on this device',
  'settings.offline.notice.nothing': 'Nothing to store. Switch on the trips you want to keep.',
  'settings.offline.notice.busy': 'A sync is already running. Try again in a moment.',
  ...
  'settings.apiScopes.noneSelected': 'Pick at least one area, or the key could not read anything.',
