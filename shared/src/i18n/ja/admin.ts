...
const admin: TranslationStrings = {
  ...
  'admin.plugins.actions': 'アクション',
  'admin.plugins.actions.confirm': 'このアクションを実行しますか？',
  'admin.plugins.actions.inactive': 'アクションを実行するにはプラグインを有効化してください',
  ...
  'admin.addons.group.count': '{total} 件中 {enabled} 件が有効',
