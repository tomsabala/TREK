...
const vacay: TranslationStrings = {
  'schoolCatalog.refreshError': 'Změna byla uložena, ale seznam se nepodařilo obnovit. Zkuste jej načíst znovu.',
  'schoolCatalog.title': 'Školní prázdniny',
  'schoolCatalog.hint': 'Spravujte sdílené regiony. Všichni je mohou vybrat v nastavení dovolené.',
  'schoolCatalog.periodHint': 'Oba krajní dny jsou zahrnuty. Přidejte období pro každý školní rok.',
  'schoolCatalog.region': 'Region nebo školní obvod',
  'schoolCatalog.name': 'Název prázdnin',
  'schoolCatalog.start': 'Datum začátku',
  'schoolCatalog.end': 'Datum konce',
  'schoolCatalog.addPeriod': 'Přidat období',
  'schoolCatalog.invalid': 'Zkontrolujte názvy a data.',
  'schoolCatalog.discard': 'Zahodit neuložené změny?',
  'schoolCatalog.country': 'Země',
  'schoolCatalog.deleteHint': 'Nejprve odstraňte regiony. Používané regiony nelze smazat.',
  'schoolCatalog.deleteCountry': 'Smazat zemi',
  'schoolCatalog.addCountry': 'Přidat zemi',
  'schoolCatalog.code': 'Kód země (např. US)',
  'schoolCatalog.empty': 'Zatím žádné regiony.',
  'schoolCatalog.addRegion': 'Přidat region',
  'schoolCatalog.offline': 'Pro správu školních prázdnin se připojte k internetu.',
  'schoolCatalog.loadError': 'Regiony se nepodařilo načíst. Znovu otevřete nastavení.',
  'schoolCatalog.retry': 'Zkusit znovu',
