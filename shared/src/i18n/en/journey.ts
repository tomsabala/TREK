...
const journey: TranslationStrings = {
  ...
  'journey.settings.showTripTracks': 'Show all trip GPX tracks',
  'journey.settings.showTripTracksHint': 'Draws the recorded routes from the linked trips on the map.',
  ...
  'journey.studio.filterPhotos': 'Filter photos',
  'journey.studio.filterAll': 'All photos',
  'journey.studio.filterLoose': 'Not in an entry',
  'journey.studio.filterRecent': 'Just uploaded',
  'journey.studio.filterThisPage': 'This page',
  ...
  'journey.studio.uploading': 'Uploading {done} of {total}',
  'journey.studio.dropFilesHere': 'Drop to add the pictures',
  'journey.studio.videosSkipped': '{count} videos were left out. A book holds pictures.',
  'journey.studio.fillPage': 'Fill page',
  'journey.studio.fillSpread': 'Fill spread',
  'journey.studio.fillHint':
    'Stretches the picture over the whole page, bleed included, and sends it behind everything else.',
  'journey.studio.stops': 'Stops',
  'journey.studio.stopsHint':
    'Every stop counts toward the route, the distance and the countries. Switch one off to leave it out, your home airport for instance.',
  'journey.studio.stopOn': 'Counts',
  'journey.studio.stopOff': 'Left out',
  'journey.studio.stopToggle': 'Count this stop',
  'journey.studio.stopsFailed': 'The stop could not be changed.',
  'journey.editor.statsExcluded': 'Leave out of the route',
