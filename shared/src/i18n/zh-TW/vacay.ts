...
const vacay: TranslationStrings = {
  'schoolCatalog.refreshError': '變更已儲存，但無法重新整理清單。請重試載入。',
  'schoolCatalog.title': '學校假期',
  'schoolCatalog.hint': '管理共用地區。所有使用者都可以在休假設定中選擇。',
  'schoolCatalog.periodHint': '包含開始與結束當天。請為每個學年新增假期。',
  'schoolCatalog.region': '地區或學區',
  'schoolCatalog.name': '假期名稱',
  'schoolCatalog.start': '開始日期',
  'schoolCatalog.end': '結束日期',
  'schoolCatalog.addPeriod': '新增假期',
  'schoolCatalog.invalid': '請檢查名稱與日期。',
  'schoolCatalog.discard': '捨棄尚未儲存的變更？',
  'schoolCatalog.country': '國家',
  'schoolCatalog.deleteHint': '請先刪除地區。使用中的地區無法刪除。',
  'schoolCatalog.deleteCountry': '刪除國家',
  'schoolCatalog.addCountry': '新增國家',
  'schoolCatalog.code': '國家代碼（如 US）',
  'schoolCatalog.empty': '尚無地區。',
  'schoolCatalog.addRegion': '新增地區',
  'schoolCatalog.offline': '請連接網際網路以管理學校假期。',
  'schoolCatalog.loadError': '無法載入地區。請重新開啟設定。',
  'schoolCatalog.retry': '重試',
