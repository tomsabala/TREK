...
const settings: TranslationStrings = {
  ...
  'settings.notifyCollectionInvite': '컬렉션 초대',
  'settings.notifySynologySessionCleared': 'Synology 세션이 초기화되었습니다',
  'settings.notifyPluginNotification': '플러그인 알림',
  ...
  'settings.notifyReplicaFailure': '스토리지 복제본 오류',
  ...
  'settings.apiScopes.noneSelected': '항목을 하나 이상 선택하세요. 그렇지 않으면 키가 아무것도 읽을 수 없습니다.',
