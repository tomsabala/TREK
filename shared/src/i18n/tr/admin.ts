...
const admin: TranslationStrings = {
  ...
  'admin.plugins.actions': 'Eylemler',
  'admin.plugins.actions.confirm': 'Bu eylem çalıştırılsın mı?',
  'admin.plugins.actions.inactive': 'Eylemlerini çalıştırmak için eklentiyi etkinleştirin',
