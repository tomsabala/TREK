...
const settings: TranslationStrings = {
  ...
  'settings.notifyCollectionInvite': 'Koleksiyon davetleri',
  'settings.notifySynologySessionCleared': 'Synology oturumu temizlendi',
  'settings.notifyPluginNotification': 'Eklenti bildirimleri',
  ...
  'settings.notifyReplicaFailure': 'Depolama kopyası hatası',
  ...
  'settings.apiScopes.noneSelected': 'En az bir alan seç, yoksa anahtar hiçbir şey okuyamaz.',
