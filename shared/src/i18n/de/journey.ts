...
const journey: TranslationStrings = {
  ...
  'journey.settings.showTripTracks': 'Alle GPX-Tracks der Reisen anzeigen',
  ...
  'journey.studio.filterPhotos': 'Fotos filtern',
  'journey.studio.filterAll': 'Alle Fotos',
  'journey.studio.filterLoose': 'Keinem Eintrag zugeordnet',
  'journey.studio.filterRecent': 'Gerade hochgeladen',
  'journey.studio.filterThisPage': 'Diese Seite',
  ...
  'journey.studio.uploading': 'Lade {done} von {total} hoch',
  'journey.studio.dropFilesHere': 'Loslassen, um die Bilder hinzuzufügen',
  'journey.studio.videosSkipped': '{count} Videos wurden ausgelassen. Ein Buch enthält Bilder.',
  'journey.studio.fillPage': 'Seite füllen',
  'journey.studio.fillSpread': 'Doppelseite füllen',
  'journey.studio.fillHint':
    'Zieht das Bild über die ganze Seite, Anschnitt inklusive, und legt es hinter alles andere.',
  'journey.studio.stops': 'Stationen',
  'journey.studio.stopsHint':
    'Jede Station zählt für Route, Distanz und Länder. Schalte eine aus, um sie auszulassen, zum Beispiel deinen Heimatflughafen.',
  'journey.studio.stopOn': 'Zählt',
  'journey.studio.stopOff': 'Ausgelassen',
  'journey.studio.stopToggle': 'Diese Station zählen',
  'journey.studio.stopsFailed': 'Die Station konnte nicht geändert werden.',
  'journey.editor.statsExcluded': 'Aus der Route herausnehmen',
  'journey.editor.statsExcludedHint':
    'Die Station bleibt im Tagebuch, zählt aber nicht für Distanz, Länder oder die Karte im Studio.',
  'journey.entry.offRoute': 'Nicht auf der Route',
  'journey.suggestions.dismiss': 'Diesen Vorschlag verwerfen',
  ...
  'journey.detail.jumpToDay': 'Zum {date} springen',
  ...
  'journey.entry.suggestion': 'Vorschlag',
