...
const vacay: TranslationStrings = {
  'schoolCatalog.refreshError': 'The change was saved, but the list could not be refreshed. Retry loading it.',
  'schoolCatalog.title': 'School holidays',
  'schoolCatalog.hint': 'Manage shared school holiday regions. Everyone can select them in vacation settings.',
  'schoolCatalog.periodHint': 'Dates include both days. Add periods for each school year.',
  'schoolCatalog.region': 'Region or school district',
  'schoolCatalog.name': 'Holiday name',
  'schoolCatalog.start': 'Start date',
  'schoolCatalog.end': 'End date',
  'schoolCatalog.addPeriod': 'Add holiday period',
  'schoolCatalog.invalid': 'Check the names and dates.',
  'schoolCatalog.discard': 'Discard unsaved changes?',
  'schoolCatalog.country': 'Country',
  'schoolCatalog.deleteHint': 'Remove regions first. Regions used by calendars cannot be deleted.',
  'schoolCatalog.deleteCountry': 'Delete country',
  'schoolCatalog.addCountry': 'Add country',
  'schoolCatalog.code': 'Country code (e.g. US)',
  'schoolCatalog.empty': 'No regions yet.',
  'schoolCatalog.addRegion': 'Add region',
  'schoolCatalog.offline': 'Connect to the internet to manage school holidays.',
  'schoolCatalog.loadError': 'Could not load school holiday regions. Reopen settings to retry.',
  'schoolCatalog.retry': 'Retry',
