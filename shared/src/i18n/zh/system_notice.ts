...
const system_notice: TranslationStrings = {
  ...
  'system_notice.release_notes.headline': '三件事，TREK 现在自己就能做到。',
  'system_notice.release_notes.intro': '自建的地点 API，从出发到抵达全程规划的公路旅行，还有重新回到你手中的位置历史。',
