...
const settings: TranslationStrings = {
  ...
  'settings.notifyCollectionInvite': 'コレクションへの招待',
  'settings.notifySynologySessionCleared': 'Synologyセッションがクリアされました',
  'settings.notifyPluginNotification': 'プラグイン通知',
  ...
  'settings.notifyReplicaFailure': 'ストレージレプリカの障害',
  ...
  'settings.offline.storage.tripFinished': '終了済み。オンにした場合のみ保存されます。',
  'settings.offline.notice.stored': '{count} 件の旅行をこの端末に保存しました',
  'settings.offline.notice.nothing': '保存するものがありません。残しておきたい旅行をオンにしてください。',
  'settings.offline.notice.busy': 'すでに同期中です。しばらくしてからもう一度お試しください。',
  ...
  'settings.apiScopes.noneSelected': '少なくとも 1 つの項目を選んでください。選ばないとキーは何も読み取れません。',
