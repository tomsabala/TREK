...
const settings: TranslationStrings = {
  ...
  'settings.notifyCollectionInvite': 'Inbjudningar till samlingar',
  'settings.notifySynologySessionCleared': 'Synology-session rensad',
  'settings.notifyPluginNotification': 'Pluginaviseringar',
  ...
  'settings.notifyReplicaFailure': 'Fel i lagringsreplik',
  ...
  'settings.apiScopes.noneSelected': 'Välj minst ett område, annars kan nyckeln inte läsa någonting.',
