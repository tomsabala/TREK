...
const collection: TranslationStrings = {
  ...
  'collections.file.targetNew': 'قائمة جديدة',
  'collections.file.targetNewHint': 'الملف كقائمة مستقلة',
  ...
  'collections.file.doneInto': 'تمت إضافة {count} مكانًا إلى {name}',
  'collections.file.doneIntoDuplicates': 'تمت إضافة {count} إلى {name}، و{duplicates} كانت موجودة بالفعل',
  'collections.file.doneIntoNothing': 'كل الأماكن في الملف موجودة بالفعل في {name}',
