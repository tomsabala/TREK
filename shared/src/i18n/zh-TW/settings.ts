...
const settings: TranslationStrings = {
  ...
  'settings.notifyCollectionInvite': '收藏邀請',
  'settings.notifySynologySessionCleared': 'Synology 工作階段已清除',
  'settings.notifyPluginNotification': '外掛通知',
  ...
  'settings.notifyReplicaFailure': '儲存複本故障',
  ...
  'settings.offline.storage.tripFinished': '已結束。僅在開啟後儲存。',
  'settings.offline.notice.stored': '已在此裝置儲存 {count} 個行程',
  'settings.offline.notice.nothing': '沒有可儲存的內容。請開啟你想保留的行程。',
  'settings.offline.notice.busy': '同步正在進行中，請稍後再試。',
  'settings.offline.notice.offline': '沒有連線。請連線以儲存行程供離線使用。',
  'settings.offline.notice.signedOut': '導覽階段已結束。請重新登入以同步。',
  'settings.offline.notice.failed': '下載未能完成。請檢查網路連線後重試。',
  'settings.offline.notice.loadFailed': '無法讀取此裝置的離線儲存。清除快取通常可以解決。',
  ...
  'settings.apiScopes.noneSelected': '請至少選擇一項，否則這組金鑰什麼都讀取不了。',
