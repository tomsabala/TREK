...
const journey: TranslationStrings = {
  ...
  'journey.suggestions.restoreCount': '넘긴 제안 ({count}개)',
  'journey.suggestions.restored': '제안 {count}개가 돌아왔습니다',
  'journey.detail.addOnThisDay': '이 날짜에 기록 추가',
  'journey.detail.jumpToDay': '{date}(으)로 이동',
  'journey.detail.searchPlaceholder': '이 여행에서 검색',
  'journey.detail.searchEmpty': '"{query}"과(와) 일치하는 기록이 없습니다',
  'journey.settings.entryFields': '기록 항목',
  'journey.settings.entryFieldsHint': '이 여행에서 쓰지 않는 항목은 꺼 두세요. 이미 쓴 내용은 사라지지 않습니다.',
  'journey.settings.showVerdict': '좋은 점과 아쉬운 점',
