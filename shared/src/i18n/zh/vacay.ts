...
const vacay: TranslationStrings = {
  'schoolCatalog.refreshError': '更改已保存，但无法刷新列表。请重试加载。',
  'schoolCatalog.title': '学校假期',
  'schoolCatalog.hint': '管理共享地区。所有用户都可以在休假设置中选择。',
  'schoolCatalog.periodHint': '包含开始和结束当天。请为每个学年添加假期。',
  'schoolCatalog.region': '地区或学区',
  'schoolCatalog.name': '假期名称',
  'schoolCatalog.start': '开始日期',
  'schoolCatalog.end': '结束日期',
  'schoolCatalog.addPeriod': '添加假期',
  'schoolCatalog.invalid': '请检查名称和日期。',
  'schoolCatalog.discard': '放弃未保存的更改？',
  'schoolCatalog.country': '国家',
  'schoolCatalog.deleteHint': '请先删除地区。正在使用的地区无法删除。',
  'schoolCatalog.deleteCountry': '删除国家',
  'schoolCatalog.addCountry': '添加国家',
  'schoolCatalog.code': '国家代码（如 US）',
  'schoolCatalog.empty': '尚无地区。',
  'schoolCatalog.addRegion': '添加地区',
  'schoolCatalog.offline': '请连接互联网以管理学校假期。',
  'schoolCatalog.loadError': '无法加载地区。请重新打开设置。',
  'schoolCatalog.retry': '重试',
