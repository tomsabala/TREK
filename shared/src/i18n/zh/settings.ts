...
const settings: TranslationStrings = {
  ...
  'settings.notifyCollectionInvite': '收藏邀请',
  'settings.notifySynologySessionCleared': 'Synology 会话已清除',
  'settings.notifyPluginNotification': '插件通知',
  ...
  'settings.notifyReplicaFailure': '存储副本故障',
  ...
  'settings.offline.storage.tripFinished': '已结束。仅在开启后保存。',
  'settings.offline.notice.stored': '已在此设备保存 {count} 个行程',
  'settings.offline.notice.nothing': '没有可保存的内容。请开启你想保留的行程。',
  'settings.offline.notice.busy': '同步正在进行中，请稍后重试。',
  'settings.offline.notice.offline': '没有连接。请连接网络以保存行程供离线使用。',
  'settings.offline.notice.signedOut': '会话已结束。请重新登录以同步。',
  'settings.offline.notice.failed': '下载未能完成。请检查网络连接后重试。',
  'settings.offline.notice.loadFailed': '无法读取此设备的离线存储。清除缓存通常可以解决。',
  ...
  'settings.apiScopes.noneSelected': '请至少选择一项，否则该密钥什么也读取不了。',
